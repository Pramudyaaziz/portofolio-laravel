...
class halamanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.halaman.index')->with('data',$data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.halaman.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success','Berhasil mengedit data');
