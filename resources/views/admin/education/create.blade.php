...
<form action="{{ route('education.store') }}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text"
        class="form-control form-control-sm" name="judul" id="judul" aria-describedby="helpId" value="{{ Session::get('judul') }}" placeholder="Pergurua Tinggi">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
      <label for="info1" class="form-label">Fakultas</label>
      <input type="text"
        class="form-control form-control-sm" name="info1" id="info1" aria-describedby="helpId" value="{{ Session::get('info1') }}" placeholder="Fakultas">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
      <label for="info2" class="form-label">Program Studi</label>
      <input type="text"
        class="form-control form-control-sm" name="info2" id="info2" aria-describedby="helpId" value="{{ Session::get('info2') }}" placeholder="Program Studi">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
      <label for="info3" class="form-label">IPK</label>
      <input type="text"
        class="form-control form-control-sm" name="info3" id="info3" aria-describedby="helpId" value="{{ Session::get('info3') }}" placeholder="IPK">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
     <div class="row">
