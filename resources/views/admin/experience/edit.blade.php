...
<form action="{{ route('experience.update', $data->id) }}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text"
        class="form-control form-control-sm" name="judul" id="judul" aria-describedby="helpId" value="{{ $data->judul }}" placeholder="Posisi">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
      <label for="info1" class="form-label">Nama Perusahaan</label>
      <input type="text"
        class="form-control form-control-sm" name="info1" id="info1" aria-describedby="helpId" value="{{$data->info1 }}" placeholder="Nama Perusahaan">
      {{-- <small id="helpId" class="form-text text-muted">Help text</small> --}}
    </div>
    <div class="mb-3">
     <div class="row">
